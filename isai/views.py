...
from isai.models import Song, Watchlater, History, Channel
...
def history(request):
    if request.method == "POST":
        ...
        return redirect(f"/isai/songs/{music_id}")
    ...
    return render(request, 'isai/history.htm', {"history": song})
...
def watchlater(request):
    if request.method == "POST":
        ...
        return render(request, f"isai/songpost.htm", {'song': song, "message": message})
    ...
    return render(request, "isai/watchlater.htm", {'song': song})

def songs(request):
    song = Song.objects.all()
    return render(request, 'isai/songs.htm', {'song': song})

def songpost(request, id):
    song = Song.objects.filter(song_id=id).first()
    return render(request, 'isai/songpost.htm', {'song': song})
...
def login(request):
    ...
    return render(request, 'isai/login.htm')
...
def signup(request):
    ...
    return render(request, 'isai/signup.htm')
...
def channel(request, channel):
    ...
    return render(request, "isai/channel.htm", {"channel": chan, "song": song})
...
def upload(request):
    ...
    return render(request, "isai/upload.htm")
